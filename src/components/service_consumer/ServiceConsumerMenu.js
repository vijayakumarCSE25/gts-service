      ...
      <div>
       <div className="container-fluid">
         <InputGroup>
           ...
           <h6 style={{paddingBottom:"20px"}}>&nbsp;<label style={{color:'black',fontSize:13}}><b>Name:</b></label><label style={{color:'red',fontSize:13 }}>{userPersonalDetails!== null ? userPersonalDetails.gts_user_first_name : ''}&nbsp;{userPersonalDetails!== null ? userPersonalDetails.gts_user_last_name : ''}</label>
