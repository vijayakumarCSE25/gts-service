      ...
      <div>
        <div className="container-fluid">
          <InputGroup>
            ...
            <h6 style={{ paddingBottom: "20px" }}>&nbsp;<label style={{ color: 'black', fontSize: "13px" }}><b>Name:&nbsp;</b></label><label style={{ color: 'red', fontSize: 13 }}>{this.state.first_name}&nbsp;{this.state.last_name}</label>
