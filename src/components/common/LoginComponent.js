...
class LoginComponent extends Component {
  ...
  submitUserLoginForm(e) {
    ...
    if (validationResult) {
      ...
      // var url=`https://rk5r6o4uo8.execute-api.ap-south-1.amazonaws.com/dev`;
              ...
              if(jsonPayLoad.primary_role==='TRAINEE'){
                window.location.href = '/gts/trainee-profile';
                 ...
                 this.setState({
                   ...
                   var personalURL=endpoints_properties.ENDPOINT_IDENTITY_LOCAL+api_properties.API_GET_USER_PERSONAL_DETAILS+jsonPayLoad.user_id;
