  ...
  render() {
    ...
    return (
      <>
        ...
        <div className="container align-items-center">      {/*MAIN className BORDER */}
          <div divID="icon" styles={iconStyles} align="right">
            {/* <i className="fas fa-map-marker-alt"></i> Location: <a href=" http://maps.google.com/?q=Bengaluru,IN" className="text-primary">Bengaluru</a> */}

            <img src={process.env.PUBLIC_URL + "/images/goraitech.jpg"}
              alt="pic" width="150px" className="iconStyles" align="left" />
          </div>

          <h1 className="text-left font-weight-bold underline" style={{ fontSize: "4.5rem" }}>GTS SERVICE PLATFORM</h1>
          <h5 className="text-left"><i>A PLATFORM FOR SERVICE PROVIDERS, SERVICE CONSUMERS, TRAINERS & TRAINEES</i></h5>
          ...
          <div className="mt-5 m-5 ">
            ...
            <div className="container">
              <div className='mt-5'>
                <div className="border m-4 p-4 border-dark" style={{ borderRadius: "20px" }}>
                  <h5 className="mb-3 text-center font-bold">WHO ARE WE?</h5>
                  <div className="column" divID="icon" styles={iconStyles} align="right">
                    <img src={process.env.PUBLIC_URL + "/images/who.jpg"}
                      alt="pic" width="100px" className="iconStyles" align="right" />
                  </div>
                  <dl className="row ">
            ...
            <div className="container">
              <div className="mt-5 mb-4">
                <div className="border m-4 p-4 border-dark" style={{ borderRadius: "20px" }}>
                  <h5 className="mb-3 text-center font-bold">WHAT WE DO?</h5>
                  <div className="column" divID="icon" styles={iconStyles} align="right">
            ...
            <div className="container">
              <div className='mt-5'>
                <div className="border m-4 p-4 border-dark" style={{ borderRadius: "20px" }}>
                  <h5 className="mb-3 text-center font-bold">HOW DO WE DO IT?</h5>
                  <div className="column" divID="icon" styles={iconStyles} align="right">
                    <img src={process.env.PUBLIC_URL + "/images/how.jpg"}
                      alt="pic" width="90px" className="iconStyles" align="right" />
                  </div>
                  <dl className="row ">
                    <dd className="text-left">
            ...
            <div className="container">
              <div className="mt-5">
                <div className="border m-4 pt-4 border-dark" style={{ borderRadius: "20px" }}>
                  <h5 className="mb-3 text-center font-bold">LOOK AT OUR STATISTICS!</h5>
                  <dl className="row text-left" className="pl-4">
                    <dd className="col-sm-7">No. of Service Providers on our platform: <span style={{ color: "blue", float: "right" }}>33,000</span></dd><br />
                    <dd className="col-sm-7">No. of Service Consumers on our platform: <span style={{ color: "blue", float: "right" }}>12,899</span></dd><br />
                    <dd className="col-sm-7">No. of Trainers on our platform: <span style={{ color: "blue", float: "right" }}>500</span></dd><br />
                    <dd className="col-sm-7">No. of Trainees on our platform: <span style={{ color: "blue", float: "right" }}>11,899</span></dd><br />
                    <dd className="col-sm-7">Services consumed by Service providers: <span style={{ color: "blue", float: "right" }}>24,750</span></dd><br />
                  </dl>
                </div>
              </div>
            </div>
            ...
            <div className="container">
              <div className="mt-5">
                <div className="border m-4 pt-4 border-dark" style={{ borderRadius: "20px" }}>
                  <h5 className="mb-3 text-center font-bold">Roles/Actions</h5>
                  <div className="row" className="pl-4">
                    <h6 className="font-bold">Service Consumer</h6>
                  ...
                  <div className="row" className="pl-4">
                    <h6 className="font-bold">Service Provider</h6>
                    <ul style={{ listStyleType: "circle" }}>
                  ...
                  <div className="row" className="pl-4">
                    <h6 className="font-bold">Trainer</h6>
                    <ul style={{ listStyleType: "circle" }}>
                      <li>
                        Trainers have the opportunity to empower service providers through world className training.
                      </li>
                      <li>
                        Consult with Service Mediator/Expert for any help.
                      </li>
                  ...
                  <div className="row" className="pl-4">
                    <h6 className="font-bold">Trainee</h6>
                    <ul style={{ listStyleType: "circle" }}>
                      <li>
            ...
            <div className="container">
              <div className='mt-5'>
                <div className="border m-4 pt-4 border-dark" style={{ borderRadius: "20px" }}>
                  <h5 className="mb-3 text-center font-bold">HEAR WHAT PEOPLE SAID ABOUT OUR PLATFORM</h5>

                  <div className="column" divID="icon" styles={iconStyles} align="left">
                    <img src={process.env.PUBLIC_URL + "/images/rev1.jpg"}
                      alt="pic" width="80px" className="iconStyles" align="left" />
                  </div>
                  ...
                  <div className="column" divID="icon" styles={iconStyles} align="right">
                    <img src={process.env.PUBLIC_URL + "/images/rev2.jpg"}
                      alt="pic" width="80px" className="iconStyles" align="right" />
                  </div>
                  <dl className="row" style={{ margin: "0" }}>
                    <dd className="text-left">
                      <i>
                  ...
                  <div className="column" divID="icon" styles={iconStyles} align="left">
                    <img src={process.env.PUBLIC_URL + "/images/rev3.jpg"}
                      alt="pic" width="80px" height="50px" className="iconStyles" align="left" />
                  </div>
                  <dl className="row" style={{ margin: "0" }}>
                    <dd className="text-left">
                      <i>
                  ...
                  <div className="column" divID="icon" styles={iconStyles} align="right">
                    <img src={process.env.PUBLIC_URL + "/images/rev4.jpg"}
                      alt="pic" width="80px" height="50px" className="iconStyles" align="right" />
                  </div>
                  <dl className="row" style={{ margin: "0" }}>
                    <dd className="text-left">
                      <i>
                  ...
                  <div className="column" divID="icon" styles={iconStyles} align="left">
                    <img src={process.env.PUBLIC_URL + "/images/rev5.jpg"}
                      alt="pic" width="80px" height="45px" className="iconStyles" align="left" />
                  </div>
                  <dl className="row" style={{ margin: "0" }}>
                    <dd className="text-left">
                      <i>
                    ...
                    <div id="carouselExampleControls" className="carousel slide" data-ride="carousel">
                      <div className="carousel-inner center">
                        <div className="carousel-item active ">
                          <img className="d-block w-100 h-50" src={"/images/training.jpg"} alt="First slide" />
                        </div>
                        <div className="carousel-item ">
                          <img className="d-block w-100 h-50" src={"/images/training2.jpg"} alt="Second slide" />
                        </div>
                ...
                <div className="border m-2  border-dark" >
                  <div className="w-100 h-50">
                    <div id="carouselExampleControls" className="carousel slide" data-ride="carousel">
                      <div className="carousel-inner center">
                        <div className="carousel-item active ">
                          <img className="d-block w-100 h-50" src={"/images/skill.jpg"} alt="First slide" />
                        </div>
                      </div>
                      <button className="carousel-control-prev" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="prev">
                        <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                ...
                <div className="border m-2  border-dark" >
                  <div className="w-100 h-50">
                    <div id="carouselExampleControls" className="carousel slide" data-ride="carousel">
                      <div className="carousel-inner center">
                        <div className="carousel-item active ">
                          <img className="d-block w-100 h-50" src={"/images/serviceProviders.jpg"} alt="First slide" />
                        </div>
